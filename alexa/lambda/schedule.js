...
function buildSchedule(periods = DEFAULT_PERIODS) {
  ...
  schedule.push({
    ...
    kind: 'complete',
    text: `Vision Protect is complete. Your ${periods} focus ${periods === 1 ? 'period has' : 'periods have'} ended. Consider taking a longer break before returning to the screen.`
  });
